...
export function zip2<T1 extends Some, T2 extends Some>(
  ...
  return map(
    zip4Internal(s1, s2, foreverUndefined(), foreverUndefined()),
    i => [i[0], i[1]] as [Maybe<T1>, Maybe<T2>]
  );
}
...
export function zip3<T1 extends Some, T2 extends Some, T3 extends Some>(
  ...
  return map(
    zip4Internal(s1, s2, s3, foreverUndefined()),
    i => [i[0], i[1], i[2]] as [Maybe<T1>, Maybe<T2>, Maybe<T3>]
  );
}

export function zip4<
  T1 extends Some,
  T2 extends Some,
  T3 extends Some,
  T4 extends Some
>(s1: Iterable<T1>, s2: Iterable<T2>, s3: Iterable<T3>, s4: Iterable<T4>) {
  return map(
    zip4Internal(s1, s2, s3, s4),
    i =>
      [i[0], i[1], i[2], i[3]] as [Maybe<T1>, Maybe<T2>, Maybe<T3>, Maybe<T4>]
  );
}
...
// tslint:disable-next-line:variable-name
export const zip3_ = <T1 extends Some, T2 extends Some, T3 extends Some>(
  s2: Iterable<T2>,
  s3: Iterable<T2>
